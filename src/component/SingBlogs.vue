...
<div class="kk"><img  :src="admin.productImage" width="370px" height="400px"></div>
   <div :data="admin"  border style="width: 100%" class="sss">

     <div class="k">

    <p style="fontSize:20px;font-weight:bold;font-weight:bold;word-warp:break-word;word-break:break-all;width:600px;">{{admin.productName}}5555555555555555555555555555555555555555555555555555555555555555555555</p>
...
<div class="ef">
    ...
    <span style="margin-left:35px;fontSize:27px;font-weight:bold;color: rgb(238, 82, 25);">￥</span>
    <span style="fontSize:31px;font-weight:bold;color: rgb(238, 82, 25);">{{admin.productPrice * admin.productNum}}.00</span>
