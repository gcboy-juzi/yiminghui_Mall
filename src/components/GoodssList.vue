   ...
   <div class="sss">
    <v-card
      ...
      >
        ...
        <v-card-text>
          <p class="swq" style="fontSize:23px;font-weight:bold;margin-left:7px;margin-top:4px;">
            ￥{{admin.productPrice}}.00
          </p>
         <p style="color: rgb(46, 46, 46);fontSize:13px;margin-left:13px;margin-top:4px;word-warp:break-word;word-break:break-all;width:273px;height:40px;">{{admin.productName}}</p>
        </v-card-text>
    ...
    <v-card
      ...
      >
        ...
        <v-card-text>
         ...
         <p style="color: rgb(46, 46, 46);fontSize:13px;margin-left:13px;margin-top:4px;word-warp:break-word;word-break:break-all;width:273px;height:40px;">{{admins.productName}}</p>
        </v-card-text>
