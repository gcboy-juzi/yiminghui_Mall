...
<td   class="kk1" style="border: 1px solid #ffff;"><div style="float:left;margin-left: 12px;word-warp:break-word;word-break:break-all; width:150px"><span >{{user.productName}}</span></div>
<div style="float:left;margin-left: 35px;word-warp:break-word;word-break: break-all; width:60px"><span>{{user.productColor}}</span></div>
<div style="float:left;margin-left: 70px;word-warp:break-word;word-break: break-all; width:85px;color:red;"><span >￥{{user.productPrice}}</span></div>
<div style="float:right;margin-right: 18px;word-warp:break-word;word-break: break-all; width:85px"><span >{{user.productNum}}</span></div></td>
...
<td class="kk2"><p style="margin-left: 30px;margin-top: 9px;">发货中</p>
<router-link v-bind:to="'/Consignmentrefund/'+user.confirmId"><p style="margin-left: 22px;margin-top: 19px;color:red">退款/退货</p></router-link>
