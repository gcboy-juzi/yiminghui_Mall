  ...
  <div>
    ...
    <div class="item-protect-container">
      ...
      <div class="item-protect-box">
        ...
        <p class="item-protect-detail">
          优易商城向您保证所售商品均为正品行货，优易自营商品开具机打发票或电子发票。
        </p>
      </div>
      <div class="item-protect-box">
        <p class="item-protect-title-box">
        ...
        <p class="item-protect-detail">
          凭质保证书及优易商城发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由优易联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。优易商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！<br><br> 注：因厂家会在没有任何提前通知的情况下更改产品包装、产地或者一些附件，本司不能确保客户收到的货物与商城图片、产地、附件说明完全一致。只能确保为原厂正货！并且保证与当时市场上同样主流新品一致。若本商城没有及时更新，请大家谅解！
        </p>
      </div>
    </div>
  </div>
