...
<div class="vv1">
  ...
  <span class="qq">
   ...
   <div class="m2"  @click="onSubmitss(notice)"><router-link v-bind:to="'/goodsDetail/'+notice.productId"><span style="word-warp:break-word;word-break:break-all;width:120px;margin-left: 50px;">{{notice.productName.substring(0, 32)}}...<img src="@/assets/bv2.png"></span>
  ...
  <span style="word-warp:break-word;word-break:break-all;width:50px;margin-left: 136px;">{{notice.productPrice}}</span>
  <span style="word-warp:break-word;word-break:break-all;width:50px;margin-left: 115px;"><el-input-number v-model="notice.productNum" @change="handleChange" :min="1" :max="notice.productMnum" size="mini" style="width:105px" ></el-input-number></span>
  <span style="word-warp:break-word;word-break:break-all;width:120px;margin-left: 175px;">省205:超值优惠</span>
  <span style="fontSize:16px;font-weight:bold;width:20px;margin-left: 128px;" class="font-weight-black"  v-rainbow  >{{notice.productNum * notice.productPrice}}.00</span>
  <!-- </div> --></div>
  </div>
...
<div class="fu1" >
  ...
  <span style="margin-right: 150px;fontSize:17px;font-weight:bold;">￥{{notice.productNum * notice.productPrice}}.00</span>
...
<span style="word-warp:break-word;word-break:break-all;width:400px;fontSize:28px;font-weight:bold;color: red;">{{notice.productNum * notice.productPrice }}.00</span>
</div >
...
<div class="cc"><router-link to="/Index"><span style="margin-right:43px;color: #0e30f0;fontSize:13px;font-weight:bold;">返回首页</span></router-link><el-button style="background: red;color: seashell;fontSize:17px;width:190px" @click="dialogFormVisibles = true;next"
        >立即支付</el-button
      >
</div>
<el-row>
