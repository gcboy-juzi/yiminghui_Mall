    ...
    >
      ...
      <div class="item-detail-right"  :data="admin" >
        <div class="item-detail-title">
          <p>
            <span class="item-detail-express" style="word-warp:break-word;word-break:break-all;width:600px;">校园配送</span>
            {{ admin.productName }}
          </p>
        </div>
      ...
      <el-radio-button   :label="admin.productCs" style="border: 1px solid silver;"></el-radio-button>
      <el-radio-button style="margin-left:30px;border: 1px solid silver;" :label="admin.productCd"></el-radio-button>
      <el-radio-button  style="margin-left:31px;border: 1px solid silver;"  :label="admin.productCf"></el-radio-button>
      <el-radio-button  style="margin-left:30px;border: 1px solid silver;"  :label="admin.productCg"></el-radio-button>
    </el-radio-group>
          </div>
        </div>
