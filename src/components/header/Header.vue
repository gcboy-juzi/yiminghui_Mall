      ...
      <ul class="detail">
        ...
        <li class="first" v-show="!admin.avatar">
          <span>请设置头像</span>
               ...
               <p class="username"><span  style="fontSize:18px;">{{admin.customerName}} </span></p>
        ...
        <li>
          <Dropdown  placement="bottom-start">
            <a href="javascript:void(0)">
              <Icon type="ios-cart-outline"></Icon> 购物车<el-badge :value="total" class="item"></el-badge>
            </a>
            <DropdownMenu slot="list">
              ...
              <div class="shopping-cart-list" v-show="notice.length > 0">
                <div class="shopping-cart-box" v-for="item in notice" :key="item.orderDetailId" @click="onSubmits(item);ju()">
